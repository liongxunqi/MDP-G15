...
# -------- Scene validation (dict is an Obstacle here) --------
...
class UIState:
    ...
    def init_plot(self):
        ...
        self.ax.set_position([0.06, 0.06, 0.68, 0.88])  # leave room on the right for the widget panel
        ...
        self.ax.set_title("Algorithm Path Planning", fontsize=11)
        ...
        self.recognized_text = self.ax.text(
            0.3, GRID_H - 0.8, "", fontsize=9, color="#227722", fontweight="bold",
        )
        self.cost_text = self.ax.text(
            0.3, GRID_H - 1.5, "", fontsize=9, color="#333333", fontweight="bold",
        )
        self.unreachable_text = self.ax.text(
            0.3, GRID_H - 2.2, "", fontsize=8, color="#cc3333", fontweight="bold",
            va="top", wrap=True,
        )
